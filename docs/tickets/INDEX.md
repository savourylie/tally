...
> **Last updated**: 2026-05-24 (added TICKET-025 through TICKET-032 — Data Visualization)
...
| #   | Ticket                                                                                                       | Status    | Depends On            | Notes        |
| --- | ------------------------------------------------------------------------------------------------------------ | --------- | --------------------- | ------------ |
| 025 | [Shared byte-formatting helper (ByteFormat)](./025-byte-format-helper.md)                                    | `pending` | —                     | Foundation for all viz views |
| 026 | [UsageStore: live "today" total + freshness](./026-usage-store-live-today.md)                                | `pending` | #009 ✅               | flow_samples query + MAX(timestamp) |
| 027 | [UsageStore: week/month totals + daily trend series](./027-usage-store-trend-week.md)                        | `blocked` | #026                  | daily_aggregates, zero-fill, today-bar substitution |
| 028 | [Today card (↓/↑) + freshness label + week/month tiles](./028-today-summary-cards.md)                        | `blocked` | #025, #026, #027      | Non-chart presentation pieces |
| 029 | [Daily trend chart (Swift Charts)](./029-daily-trend-chart.md)                                               | `blocked` | #025, #027            | Stacked bars + window picker |
